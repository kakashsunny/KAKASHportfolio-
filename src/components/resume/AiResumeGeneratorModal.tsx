...
export const AiResumeGeneratorModal: React.FC = () => {
  ...
  const generateRoleResume = async (roleToGenerate: string) => {
    ...
    try {
      ...
      setResumeText(
        `# K AKASH\n**AI/ML & Full Stack Engineer** | Bengaluru, India\n${profile?.email || 'akash@example.com'}\n\n## PROFESSIONAL SUMMARY\nB.Tech Computer Science student specializing in ${roleToGenerate} systems, AI/ML, and full-stack development.\n\n## CORE TECHNICAL COMPETENCIES\n- Languages: Python, TypeScript, JavaScript, Java, C++, SQL\n- Frameworks & Tools: React, Vite, Node.js, Express.js, PostgreSQL, MongoDB\n- Cloud & AI: Gemini API, LangChain, RAG systems, machine learning\n\n## FEATURED PROJECTS\n- Formly AI: AI-native form builder using React, Node.js, PostgreSQL, JWT, and Gemini API.\n- MongoDB Mastery: Interactive learning platform covering 140+ MongoDB topics.\n- AgriGuard: Hyperlocal AI crop-advisory platform concept.\n\n## CERTIFICATIONS\n- Google Cloud Skills Boost - AI Track\n- Python Programming - Grade A\n\n## EDUCATION\n- B.Tech Computer Science & Engineering, CMR University (8.52 CGPA)`
      );
    } finally {
